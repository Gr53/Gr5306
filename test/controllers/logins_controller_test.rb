...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { email: @login.email, password_digest: @login.password_digest } }, as: :json
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { email: @login.email, password_digest: @login.password_digest } }, as: :json
    assert_response 200
  end
